    ...
    switch (ch)
    {
        ...
        default: 
        {
            if (isalpha(ch))
            {
                ...
                cin.putback(ch);
                if (s == sqrtkey) return Token{sqare};
...
try {
    ...
    cout << "You can use '+' '-' '*' '/' and '%' operator.\n";
    cout << "Moreover, 'pi' 'e' and 'k' are also available.\n";
    cout << "You can print with '=', and exit with 'quit'.\n";
